...
from libero_bootstrap import bootstrap_libero
...
from qi.utils.pytorch_utils import set_global_seed
...
def _get_task_init_states_compat(task_suite: Any, task_id: int) -> Any:
...
def eval_single_process(cfg: DictConfig):
    ...
    initial_states = _get_task_init_states_compat(task_suite, cfg.EVALUATION.task_id)
