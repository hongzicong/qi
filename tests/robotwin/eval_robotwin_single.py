...
- Check or create the symlink:
  `RoboTwin/policy/fastwam_policy -> tests/robotwin/fastwam_policy`.
...
def main(cfg: DictConfig):
    ...
    policy_source_dir = (PROJECT_ROOT / "tests" / "robotwin" / POLICY_NAME).resolve()
    ...
    _append_override(overrides, "expert_cache", cfg.EVALUATION.get("expert_cache", False))
